                            ...
                            <?php foreach ($teacher_schedules as $index => $schedule): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-warning btn-sm edit-schedule" data-schedule-id="<?php echo $schedule['schedule_id']; ?>" data-day="<?php echo $schedule['day_of_week']; ?>" data-start="<?php echo $schedule['start_time']; ?>" data-end="<?php echo $schedule['end_time']; ?>" data-available="<?php echo $schedule['is_available']; ?>">
                                            <i class="bi bi-pencil"></i> แก้ไข
                                        </button>
                                        <a href="teacher_availability.php?teacher_id=<?php echo $selected_teacher_id; ?>&delete_schedule=<?php echo $schedule['schedule_id']; ?>" class="btn btn-danger btn-sm btn-delete" data-item-name="ตารางว่างวัน<?php echo $schedule['day_of_week']; ?> เวลา <?php echo date('H:i', strtotime($schedule['start_time'])); ?> - <?php echo date('H:i', strtotime($schedule['end_time'])); ?> น.">
