...
<ul class="nav flex-column">
    <!-- แดชบอร์ด -->
    <li class="nav-item">
        <a href="../admin/dashboard.php" class="sidebar-item <?php echo ($currentPage === 'dashboard') ? 'active' : ''; ?>">
    ...
    <li class="nav-item">
        <a href="../admin/requests/index.php" class="sidebar-item <?php echo ($currentPage === 'requests') ? 'active' : ''; ?>">
    ...
    <li class="nav-item">
        ...
        <div class="collapse <?php echo (strpos($currentPage, 'schedules') !== false) ? 'show' : ''; ?>" id="collapseSchedules">
            <ul class="sidebar-submenu">
                <li>
                    <a href="../admin/schedules/index.php" class="sidebar-submenu-item <?php echo ($currentPage === 'schedules-list') ? 'active' : ''; ?>">
                        รายการตารางเรียน
                    </a>
                </li>
                <li>
                    <a href="../admin/schedules/create.php" class="sidebar-submenu-item <?php echo ($currentPage === 'schedules-create') ? 'active' : ''; ?>">
                        สร้างตารางเรียน
                    </a>
                </li>
                <li>
                    <a href="../admin/schedules/teacher_availability.php" class="sidebar-submenu-item <?php echo ($currentPage === 'schedules-teacher') ? 'active' : ''; ?>">
                        เวลาว่างของครู
                    </a>
                </li>
            </ul>
    ...
    <li class="nav-item">
        <a href="../admin/students/index.php" class="sidebar-item <?php echo ($currentPage === 'students') ? 'active' : ''; ?>">
    ...
    <!-- จัดการข้อมูลรายวิชา -->
    <li class="nav-item">
        <a href="../admin/courses/index.php" class="sidebar-item <?php echo ($currentPage === 'courses') ? 'active' : ''; ?>">
    ...
    <!-- จัดการข้อมูลครู -->
    <li class="nav-item">
        <a href="../admin/teachers/index.php" class="sidebar-item <?php echo ($currentPage === 'teachers') ? 'active' : ''; ?>">
    ...
    <li class="nav-item">
        ...
        <div class="collapse <?php echo (strpos($currentPage, 'reports') !== false) ? 'show' : ''; ?>" id="collapseReports">
            <ul class="sidebar-submenu">
                <li>
                    <a href="../admin/reports/course_summary.php" class="sidebar-submenu-item <?php echo ($currentPage === 'reports-course') ? 'active' : ''; ?>">
                        สรุปการขอเปิดรายวิชา
                    </a>
                </li>
                <li>
                    <a href="../admin/reports/student_requests.php" class="sidebar-submenu-item <?php echo ($currentPage === 'reports-student') ? 'active' : ''; ?>">
